...
public class DijkstraAlgorithm {
    ...
    public static void main(String[] args) {
        ...
        Result result = findShortestPath(graph, 0, 7);

        System.out.println("Shortest path cost to Target: " + (result.totalCost() == Integer.MAX_VALUE ? "UNREACHABLE" : result.totalCost()));
        System.out.println("Path: " + (result.path().isEmpty() ? "None" : result.path()));
    }
}
